...
import logo from '../Images/Immersive-Logo.png'
    ...
    return (
        <div className='shadow-2xl w-full fixed top-0 left-0 z-[100] '>
            <div className={`md:flex items-center justify-between bg-white py-4 md:px-16 px-7`}>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 bg-white absolute md:static md:z-auto z-[-1] left-0 text-black w-full h-[350%] md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-12' : 'top-[-490px]'}`}>
                ...
                <div className="hidden lg:block"> {/* Hide the button on screens smaller than md */}
                    <button className='text-lg bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded'>Call Us Now</button>
                </div>
            </div>
        </div>
    );
